  ...
  <div class="overflow-hidden">
    ...
    <div class="row">
      ...
      <div class="p-5 border col-md-5">
        <div class="comments-area overflow-y-auto" style="height: 90vh">
          ...
          <div class="flex items-center">
            ...
            <div class="flex items-center py-4 follow">
              <span class="w-10 h-10 p-2 text-center text-white bg-black rounded-full me-1">
                ✔</span
              >
          ...
          <div class="comments">
            <div class="flex items-center">
              <div class="flex items-center py-4 mr-4 avatar">
                ...
                <p class="px-2 pb-0 mb-0 text-xl">
                  @username <br />
            ...
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae voluptatibus vitae
              incidunt? Facilis ipsam sapiente vel veritatis, nihil rem repellendus veniam et illum
              qui eos facere non impedit provident porro.
            </p>
