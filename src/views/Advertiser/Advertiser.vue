                ...
                <div class="flex align-items-center">
                    <div class="w-full form-group position-relative">
                        <div class="left-0 px-3 position-absolute top-2">
                            ...
                            <div class="dropdown">
                            <button class="p-0 mx-2 font-bold btn dropdown-toggle" type="button" id="triggerId" data-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false" @click="SearchDrop()">
                                    <fa icon="fa-magnifying-glass " /> 
                                    </button>
                            <div class="left-0 dropdown-menu show" aria-labelledby="triggerId" style="left:-20px;" v-if="OpenSearch">
                      ...
                      <input type="text" class="h-10 pl-14 form-control" name="" id="" aria-describedby="helpId" placeholder="Advertisers name">
                      ...
                      <div class="right-0 px-3 position-absolute top-2 d-flex align-items-center">
                        ...
                        <div class="dropdown">
                            <button class="p-0 mx-2 font-bold btn dropdown-toggle" type="button" id="triggerId" data-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false" @click="DropDown()">
                                        All
                                    </button>
                            <div class="left-0 dropdown-menu show" aria-labelledby="triggerId" style="left:-103px;" v-if="openDrop">
                      ...
                      <router-link to="/product-details" class="flex ">
                            ...
                            <div v-bind:id="x.id" class="carousel slide">
                                ...
                                <div class="carousel-inner">
                                  <div class=" carousel-item active">
                                    <img v-bind:src="its.productsPhoto" alt="" class="w-full rounded-md h-fit" style="height:125px" />
                                  </div>
                                ...
                                <button class="carousel-control-prev text-dark" type="button" v-bind:data-bs-target="'#'+x.id" data-bs-slide="prev">
                                  <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                  <span class="visually-hidden">Previous</span>
                                </button>
                                <button class="carousel-control-next text-dark" type="button" v-bind:data-bs-target="'#'+ x.id" data-bs-slide="next">
                        ...
                        <div class="w-3/4 px-5">
                          <div class="flex items-center justify-between font-bold ">
                            <h2 class="mb-0 text-lg">{{ x.name }} <button type="button" class="mx-4 text-black"> <span class="w-4 h-4 text-white bg-black rounded-lg font-weight-light">✔</span> Follow Now</button> <br>
                             <span class="text-sm ">{{ x.userName }}</span></h2>
